...
public class Show implements Serializable {
    ...
    /** Empty constructor so JSON tools can build a Show from network data. */
    public Show() {
    ...
    /** Updates the show id (used when deserializing or editing). */
    ...
    /** Replaces the whole seat list (for example after admin edits). */
